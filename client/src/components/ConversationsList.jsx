...
const getOtherUserInfo = (conversation, currentUserId) => {
...
function ConversationItem({ conversation, isSelected, onSelect, currentUserId }) {
  const otherUser = getOtherUserInfo(conversation, currentUserId)
...
export function ConversationsList({ conversations, selectedId, onSelect, currentUserId }) {
